...
(function ($) {
    ...
    function parseContentToHtml(htmlString) {

        var htmlContent;
        htmlContent = $.parseHTML(htmlString);
        return htmlContent;
    }
    ...
    var t_methods = {
        init: function (options) {
            ...
            my_styel_4_resize_image = function (my_scale) {
                ...
                $this.find(".item").each(function (i, v) {
                    ...
                    var bott = $(v).find(".vertical_con_borderImage").offset().top;
                    var h = $(v).find(".vertical_con_borderImage").height();
                    bott += h;
                    var bott_1 = $(v).find(".my_vertical_timeline_content").offset().top;//+$(v).offset().top;//+$(v).find("h2").outerHeight()+$(v).find(".my_post_date").outerHeight()+h;

                    var rel_pos_image = $(v).find(".vertical_con_borderImage").offset().top - $(v).offset().top;

                    var h_content = $(v).find(".my_vertical_timeline_content").height();

                    if (my_debug_12 && window.console) {
                        console.log("Resize image", {
                            rel_pos_image: rel_pos_image,
                            h: h,
                            h_content: h_content,
                            padd: padd,
                            bott: bott,
                    ...
                    if (bott > bott_1) {
                        ...
                        h -= diff;
                        $(v).find(".vertical_con_borderImage").height(h);
                        var diff_1 = diff / 2;
                        $(v).find(".vertical_con_borderImage img").css('top', '-' + diff_1 + 'px');
                        ...
                        $(v).find(".vertical_con_borderImage img").css('top', '');
                        if (my_debug_12 && window.console) {
            ...
            myCalculateMargin = function (currIndex, newIndex) {
                ...
                if (my_settings.myIsSmall) {
                    ...
                    $this.VerticalTimeline("my_debug", "Current eleemebnt", {
                        settings: settings,
            ...
            myFindTimelineItemsHeight = function () {
                ...
                //	var $this = this,
                var data = $this.data('vrt_timeline');
                ...
                var margin_top = '';
                var margin_top_1 = '';
                var width = $this.find(".vertical_timeline_items").width();
                var myMarginTop = 0;
                ...
                if (width <= my_settings.mySmall) {
                    ...
                    if (my_debug_12 && window.console) {
                        console.log("Width is reposnonse set small", {
                            width: width,
                ...
                $this.find('.vertical_timeline_items').css({height: total_1});

                $this.find('.vertical_vertical_timeline_items_holder').css({
                    overflow: 'hidden',
                    height: total + 'px',
                    marginLeft: 'auto',
                    marginRight: 'auto'
                ...
                if (typeof data != 'undefined') {
                    ...
                    $this.find('.vertical_timeline_items').css({marginTop: myMarginTop});
                }
            ...
            my_500px_window_function = function () {
                ...
                if (my_debug_12 && window.console) {
                    console.log("500px window function", {
                        itemWidth: itemWidth,
                ...
                if (containerWidth <= my_trigger_width) {
                    if (containerWidth < itemWidth) {
                        ...
                        $this.find(".item .vertical_con_borderImage img").css('left', diff + 'px');

                        $this.find(".item").width(containerWidth);
                        if ($this.find(".my_vertical_timeline_content").length > 0) {
                            var my_margin = $this.find(".my_vertical_timeline_content").css('margin-left');
                            var m_l = parseFloat(my_margin);
                            $this.find(".my_vertical_timeline_content").width((containerWidth - 2 * m_l));
                        }
                        ...
                        $this.find(".item .vertical_con_borderImage img").css('left', '');
                        //}
                        if ($this.find(".my_vertical_timeline_content").length > 0) {
                            var my_margin = $this.find(".my_vertical_timeline_content").css('margin-left');
                            var m_l = parseFloat(my_margin);
                            $this.find(".my_vertical_timeline_content").width((itemWidth - 2 * m_l));
                        }
                    ...
                    if (containerWidth < itemOpenWidth) {
                        if (my_debug) {
                            if (window.console) {
                                console.log('Container is less set open width', {
                                    c_w: containerWidth,
                                    i_w: itemWidth,
                                    o_w: itemOpenWidth
                                });
                        ...
                        $this.find(".item_open a.vertical_con_borderImage").css('left', diff_1 + 'px');
                        ...
                        $this.find(".item_open a.vertical_con_borderImage").css('left', '');
            ...
            $this.wrapInner('<div class="vertical_timeline_items" />');
            /**
             * my wrap inner
             */
            //$this.wrapInner('<div class="my_vertical_vertical_timeline_items_wrapper" />');
            /**
             * end changes
             */

            $this.find('.vertical_timeline_items').css('text-align', 'left');
            ...
            $this.wrapInner('<div class="vertical_vertical_timeline_items_holder" />');
            if (!settings.hideControles) {
                //	$this.append('<div class="t_controles"><div class="t_left"></div><div class="t_right"></div></div>')
                $this.append('<div class="t_controles"><div class="t_left"></div><div class="t_right"></div></div>');
            }
            $this.wrapInner('<div class="vertical_vertical_timeline_items_wrapper" />');
            if (settings.search_bar_position == 0) {
                $this.prepend('<div class="vertical_search_bar_holder" style="transform:translate(0,-90px) !important;"><input id="vertical_search-cards" style="padding-left:10px;width: 50%; height: 100%; margin: auto; " placeholder="Search specific card..." type="text"/></div>');
                $('.vertical_timeline_line').addClass('search_pos');
            }
            else if (settings.search_bar_position == 1) {
                $this.prepend('<div class="vertical_search_bar_holder"><input id="vertical_search-cards" style="padding-left:10px; width: 50%; height: 100%; margin: auto;" placeholder="Search specific card..." type="text"/></div>');
            }
            else {
                $this.append('<div class="vertical_search_bar_holder" style="margin-bottom: 20px;"><input id="vertical_search-cards" style="padding-left:10px; width: 50%; height: 100%; margin: auto;" placeholder="Search specific card..." type="text"/></div>');
            }
            $this.find('.vertical_vertical_timeline_items_wrapper').append('<div class="myVerticalLine"></div>');
            ...
            my_scale_items_12 = function (my_scale) {
                //	if(my_w_12<600){
                var data = $this.data('vrt_timeline');
                var $iholder = $this.find('.vertical_timeline_items:first');
                var my_settings = $this.data('my_settings');
                ...
                if ((my_scale < 1 || my_scale == 1) && my_scale_1 != '' && (typeof my_settings != 'undefined')) {
                    ...
                    if (true) { //alwas call this
                        ...
                        var my_width = $this.find(".vertical_vertical_timeline_items_wrapper").width();
                        var my_open_width = data.itemOpenWidth;
                        var my_diff = 0;
                        //data.my_diff_window_resize=my_diff;
                        if (typeof data != 'undefined') {
                            $this.VerticalTimeline("my_debug", "Scale Factors", {
                                my_scale: my_scale,
                        ...
                        if ((my_scale == 1) && (data.my_scale_1 < 1)) {
                            ...
                            if (my_debug_12 && window.console) {
                                console.log("My scale is same <1", {
                                    width: my_width,
                                    my_diff: my_diff,
                                    old_width: my_old_width
                                });
                            }
                            my_settings.my_width_12 = my_width;
                        ...
                        if (my_debug_12 && window.console) {
                            console.log("My scale function Diff margin", {
                                my_scale: my_scale,
                                my_scale_1: data.my_scale_1,
                                my_diff: my_diff
                            });
            ...
            // Get new queries
            var $iholder = $this.find('.vertical_timeline_items:first'),
                $line = $this.find('.vertical_t_line_wrapper:first'),
            ...
            settings.my_width_12 = $this.find(".vertical_vertical_timeline_items_wrapper").width();
            ;
            ...
            var mydiff = 0;
            myh12 -= mydiff;//*2;
            //var my_top_12=$this.find(".vertical_vertical_timeline_items_wrapper").css('margin-top');
            var h123 = $this.find(".vertical_vertical_timeline_items_holder").height();
            ...
            $this.find(".t_left , .t_right").on("mouseenter", function (e) {
                ...
                var data = $("#vtl" + settings.my_id).data('vrt_timeline');
                if (data.open) {
                    $(this).hide();
                    return;
                } else $(this).show();
                ...
                my_slider_set_timeout_12 = setTimeout(function (e) {
                    ...
                    //var $p=$(e.target);
                    $p.finish();
                    //$this.find(".vertical_timeline_items").finish();
                    $this.find(".vertical_timeline_items").finish('my_left_12');

                    var w = $p.height();
                    $p.data('my-w-12', w);
                    w = 70;
                    var m_l = data.marginTop;//=$this.find(".vertical_timeline_items").css('margin-left');
                    //$this.find(".vertical_timeline_items").data('my-l-12',m_l);
                    if (my_debug_12 && window.console) {
                    ...
                    $this.find(".vertical_timeline_items").animate({
                        'margin-top': m_l,
                        'queue': 'my_left_12'
                    }, 350, function () {
                        var data = $("#vtl" + settings.my_id).data('vrt_timeline');
            ...
            my_slider_mouse_leave_arrows = function (e) {
                //var $this = this,
                data = $("#vtl" + settings.my_id).data('vrt_timeline'),
                    speed = data.options.scrollSpeed,
                    easing = data.options.easing;
                ...
                if ($($this.find(".vertical_timeline_items")).is(":animated")) {
                ...
                if (data.myUpDownArrow) {
                    ...
                    $this.find(".vertical_timeline_items").animate({'margin-top': m_l, 'queue': 'my_left_12'}, 350);
                }
                //var data = $this.data('vrt_timeline');
                //data.margin=m_l;
            };//);
            ...
            my_center_style_3 = function () {
                ...
                if ($this.hasClass('my_style_style_3')) {
                    $this.find(settings.itemClass).each(function (i, v) {
                        ...
                        var t_h = $(v).find(".my_vertical_timeline_content").outerHeight();
                        ...
                        $this.VerticalTimeline("my_debug", "Center style", {
                            image_h: i_h,
                            t_h: t_h,
                            it_h: it_h,
                            top: top,
                        ...
                        if (p != 0) {
                            $(v).find(".my_vertical_timeline_content").css('bottom', p + 'px');
                        }
            ...
            $(window).resize(function () {
                ...
                var speed = data.options.scrollSpeed,
                    easing = data.options.easing,
                    $items = data.items,
                    timelineWidth = $this.find('.vertical_timeline_line').width(),
                    count = -1,
                    found = false;
                var id;
                ...
                var $nodes = $this.find('.vertical_t_line_node');
                ...
                if ($this.find('.vertical_t_line_view:first').width() > $this.find('.vertical_timeline_line').width()) {
                    data.lineMargin *= 2;
                ...
                if (data.noAnimation) {
                    ...
                    $this.find('.vertical_t_line_wrapper').stop(true).css({marginLeft: data.lineMargin + '%'});
                }
                else {
                    $this.find('.vertical_t_line_wrapper').stop(true).animate({marginLeft: data.lineMargin + '%'}, speed, easing);
                }
                    ...
                    if (data.open) {
                        if (typeof data != 'undefined') {
                            ...
                            if (typeof my_width_12 != 'undefined') {
                                $this.VerticalTimeline("my_debug", "Open Change open width", {
                                    width: width,
                                    my_width_12: my_width_12
                                });
                                width = my_width_12;

                            }
                            $this.VerticalTimeline("my_debug", "Resize scale factors", {
                                my_scale: my_scale,
                                my_scale_open: my_scale_open
                            });
                            ...
                            if (my_scale < 1 || my_scale_open < 1) {
                                ...
                                $this.VerticalTimeline("my_debug", "Resize Calculate position scale<1", {
                                    itemWidth: itemWidth,
                                    openWidth: width,
                                    containerWidth: my_width,
                                    my_scale_1: my_scale_1,
                                    my_scale: my_scale,
                                    my_diff_pos: my_diff_pos
                                });
                            ...
                            $this.VerticalTimeline("my_debug", "Data margin", {
                                my_scale: my_scale,
                                my_diff_pos: my_diff_pos,
                                margin: data.margin
                            });
            ...
            $(document).ready(function () {
                ...
                $('.vertical_timeline_items .item img').on('dragstart', function (event) {
                    if (!($(this).hasClass('vertical_timeline_rollover_bottom')))
                        event.preventDefault();
                });
                var htmlArray = [];

                function extractOpenCardContent() {
                    ...
                    $('.item_open').each(function (index) {
                        ...
                        if (typeof $(this).attr('data-access') != 'undefined' && $(this).attr('data-access') != '') {
                            ...
                            $.post(action, function (data) {
                                htmlArray[index] = $.parseHTML(data);
                            });
                ...
                $('.vertical_timeline_items .vertical_timeline_rollover_bottom').on('dragstart', function (event) {
                ...
                $('.vertical_timeline_items .vertical_timeline_rollover_bottom').on('mousedown', function (event) {
                    if (!$(this).is("hover")) {
                        $(this).removeClass("disableClick");
                    }
                });

                $('.vertical_timeline_items .vertical_timeline_rollover_bottom').on('click', function (event) {
                ...
                //SEARCH CARDS
                var testOpenCardContent = extractOpenCardContent();

                $('#vertical_search-cards').keyup(function () {
                    ...
                    if (valThis != '') {
                        ...
                        $('.vertical_timeline .item, #content .vertical_timeline .item').each(function (index) {

                            var textTitle = $(this).find('h2').text().toLowerCase();
                            var textSpan = $(this).find('span').text().toLowerCase();
                            var $itemOpenContent = $(testOpenCardContent[index].slice(-1));

                            var openTextTitle = $itemOpenContent.find(':first-child').text().toLowerCase();

                            var openTextContent = $itemOpenContent.find('.scrollable-content').text().toLowerCase();

                            if ($(this).find('h2').text().toLowerCase().indexOf(valThis) == -1 && $(this).find('span').text().toLowerCase().indexOf(valThis) == -1
                                && $(this).next().find('h2').text().toLowerCase().indexOf(valThis) == -1 && openTextTitle.indexOf(valThis) == -1 && openTextContent.indexOf(valThis) == -1) {

                                $(this).addClass('disable-cards-elements').find('*').addClass('disable-cards-elements');


                                $('#vertical_t_line_backward').trigger('click');
                            }
                            else {
                        ...
                        $('.vertical_timeline .item, #content .vertical_timeline .item').each(function () {
                            $(this).removeClass('disable-cards-elements').find('*').removeClass('disable-cards-elements');
                            $(this).attr('data-count', data_count);
                            $(this).find('.read_more').attr('data-count', data_count);
                            $(this).next().attr('data-count', data_count_open);
            ...
            if (settings.swipeOn) {
                ...
                $this.find(".vertical_timeline_items").bind('touchstart', function (e) {
                    $this.VerticalTimeline('touchStart', e);
                });


                $this.find(".vertical_timeline_items").mousedown(function (e) {
            ...
            if (settings.my_post_link == 0) {
                $this.find(settings.openTriggerClass).click(function () {
                    $this.VerticalTimeline("my_debug", "Click on read more", {
            ...
            $this.find('.t_close').click(function () {
                $this.VerticalTimeline("my_debug", "Click close open", {
                    id: $(this).attr('data-id'),
                    count: $(this).attr('data-count')
                });
            ...
            $this.find('.vertical_t_line_node').each(function () {
             ...
             */
            var my_w = $this.width();
            var my_l = $this.find(".vertical_t_line_holder").width();
            ...
            if (my_diff < 60 && my_diff > 0) {
                ...
                if (my_diff > 0) {
                    ...
                    $this.find('#vertical_t_line_left').css('left', '-' + my_p + 'px');
                    $this.find('#vertical_t_line_right').css('right', '-' + my_p + 'px');

                }

            } else {
                $this.find('#vertical_t_line_left').css('left', '');
                $this.find('#vertical_t_line_right').css('right', '');
        ...
        destroy: function () {
            ...
            var $this = this,
                data = $this.data('vrt_timeline');
            $this.removeData('vrt_timeline');

        },

        touchStart: function (evt) {
            if ($(evt.target).hasClass("vertical_t_line_node") || $(evt.target).hasClass("t_close") || $(evt.target).hasClass("read_more") || $(evt.target).hasClass("my_read_more") || $(evt.target).hasClass("my_read_more_1")) {
        ...
        touchEnd: function (xpos) {
            ...
            if (typeof data.touchHorizontal != 'undefined' && data.touchHorizontal) {
                ...
                $this.VerticalTimeline("my_debug", "touchend", {
                    itemC: itemC,
                    xmargin: xmargin,
                    mod: mod,
                    my_del: my_del,
                    my_calc_old_1: my_calc_old_1,
                    my_calc_old_2: my_calc_old_2
                });
        ...
        mouseUp: function (xpos) {
            ...
            itemC -= parseInt(xmargin / itemWidth);
            mod = xmargin % itemWidth;
            $this.VerticalTimeline("my_debug", "Mouse Up", {
                itemC: itemC,
                xmargin: xmargin,
                mod: mod,
                my_del: my_del,
        ...
        open: function (id, data_count) {
            ...
            var my_settings = $this.data('my_settings');
            if (my_settings.vertical == 1) {
                $this.VerticalTimeline("my_debug", "Vertical open", {
...
//
                                    ...
                                    $.post(action, function (data) {
                                        ...
                                        if ($('.ajax_preloading_holder img').length > 0) {
                                            $('.ajax_preloading_holder img').load(function () {
                                                ...
                                                $("body").trigger(event);
                                                $this.trigger(event);
                                                var my_scale_open = my_settings.my_scale;
                                                ;//$this.find(".item_open").data('my-scale');
                                                $this.VerticalTimeline("my_debug", "My open scale", my_scale_open);
                                                if (my_scale_open < 1) {

                                                    var diff = -(Math.abs(containerWidth * (1 - my_scale_open))) / 2;
                                                    $this.find(".item_open a.vertical_con_borderImage ").css('left', diff + 'px');
                ...
                if ((my_scale < 1) || (my_scale_open < 1)) {
                    ...
                    var my_end_item = 1;
                    var my_count = 1;
                    $this.VerticalTimeline("my_debug", "Open Start end pos scale<1", {
                        my_start: my_start_item,
                        my_end: my_end_item,
                        my_count: my_count,
                        my_scale: my_scale
                    });
                    ...
                    $this.VerticalTimeline("my_debug", "Open my_scale<1", {
                        itemWidth: itemWidth,
                        my_width_1: my_width_1
                    });
                } else {
                    var my_visible_area_left = Math.abs(data.margin);
                    var my_width = $this.find(".vertical_vertical_timeline_items_wrapper").width();
                    var my_left = $this.find(".vertical_vertical_timeline_items_wrapper").offset().left;
                    ...
                    $this.VerticalTimeline("my_debug", "Set correct position ", {
                        my_pos_12: my_pos_12,
                    ...
                    $this.VerticalTimeline("my_debug", "Open Start end pos scale=1", {
                        id: id,
                        inner: my_inner_items,
                        data_count: data_count,
                        left: my_visible_area_left,
                        right: my_visible_area_right,
                        my_width_1: my_width_1,
                        my_start: my_start_item,
                        my_end: my_end_item
                    });
                    $this.VerticalTimeline("my_debug", "Open Start end pos scale=1", {
                        width: width,
                        my_start_item: my_start_item,
                        my_end_item: my_end_item
                    });
                    var my_pom = 0;
                    ...
                    if (typeof data.my_pos_curr != 'undefined') {
                        $this.VerticalTimeline("my_debug", "Open Correct position", {
                            my_curr: my_curr,
                            new_pos: data.my_pos_curr
                        });
                    ...
                    $this.VerticalTimeline("my_debug", "Open position", {
                        my_margin: my_margin,
                        my_margin_abs: my_margin_abs,
                        my_center_pos: my_center_pos
                    });
                    ...
                    if (my_curr > 0) {
                        if (data.margin < 0) {
                            ...
                            $this.VerticalTimeline("my_debug", "Open Calcl left", {
                                my_left_off: my_left_off,
                                my_left_off_1: my_left_off_1,
                                my_diff_left: my_diff_left
                            });
...
//
                                        ...
                                        if ($('.ajax_preloading_holder img').length > 0) {
                                            $('.ajax_preloading_holder img').load(function () {
                                                ...
                                                if (my_scale_open < 1) {
                                                    ...
                                                    $this.find(".item_open a.vertical_con_borderImage ").css('left', diff + 'px');
                                                    $this.VerticalTimeline("my_debug", "My open scale", {
                                                        cntWidth: containerWidth,
                                                        itemOpenWidth: itemOpenWidth,
                                                        diff: diff
                                                    });
                                    ...
                                    if (data.margin > 0) {
                                        ...
                                        if (my_curr > 0) {
                                            if (my_pos > 0) {
                                                ...
                                                $this.VerticalTimeline("my_debug", "Open Position left is ", {
                                                    my_pos_left: my_pos_left,
                                                    my_center_pos: my_center_pos
                                                });
                                                ...
                                                if (my_pos_left > my_center_pos) {
                                                    ...
                                                    $this.VerticalTimeline("my_debug", "Open Position is smaller", {
                                                        my_diff_1: my_diff_1,
                                                        my_diff_2: my_diff_2,
                                                        my_diff_pos: my_diff_pos
                                                    });
        ...
        close: function (id, idOpen, dataCountOpen) {
            ...
            if (false) {
                ...
                if ($(this).find('.item[data-count="' + dataCountOpen + '"] a.read_more[href="#"]').length == 0 || $(this).find('.item[data-count="' + dataCountOpen + '"] a.my_read_more[href="#"]').length == 0) {
                    ...
                    $this.VerticalTimeline("my_debug", "Close Open an item", {
                        idOpen: idOpen,
                        dataCount: dataCountOpen
                    });
        ...
        up: function () {
            ...
            if (data.currentIndex > 0) {
                ...
                $this.VerticalTimeline("my_debug", "Up", {
                    dataId: dataId,
                    dataCount: dataCount,
                    items: data.items,
        ...
        bottom: function () {
            ...
            if (data.currentIndex < data.itemCount - 1) {
                var dataId = data.items.eq(data.currentIndex + 1).attr('data-id');
                var dataCount = data.items.eq(data.currentIndex + 1).attr('data-count');
                $this.VerticalTimeline("my_debug", "Down", {
                    dataId: dataId,
                    dataCount: dataCount,
                    items: data.items,
                    ind: data.currentIndex
        ...
        goTo: function (id, data_count, openElement) {
            ...
            $this.VerticalTimeline("my_debug", "Go to function params", {
                id: id,
                data_count: data_count,
            ...
            if (my_settings.vertical == 1) {
                var my_scale = my_settings.my_scale;
                $this.VerticalTimeline("my_debug", "Go to scale Vertical", {
                    id: id,
                    data_count: data_count,
                    scale: my_scale
                });
                ...
                if (found) {
                    ...
                    if (data.open) {
                        ...
                        delete data.my_pos_curr;
                        $this.VerticalTimeline("my_debug", " Go To Open postion", {
                            open: openElement,
                            id: id,
                            count: data_count
                        });
                    ...
                    $this.VerticalTimeline("my_debug", "Go To Count", {
                        curr: data.currentIndex,
                        width: data.itemWidth,
                        my_scale: my_scale,
                        count: count,
                        pre: my_pre_index_123,
                        margin: data.margin
                    });
                ...
                if (found) {
                    ...
                    if (my_scale == 1) {
                        ...
                        //var my_w_12=$this.find(".vertical_vertical_timeline_items_holder").width();
        ...
        lineBackward: function () {
            ...
            $this.find('.vertical_t_line_backward').addClass('backward-clicked');
            ...
            $this.find('#vertical_t_line_backward').removeClass('backward-clicked');
        },
        ...
        lineForward: function () {
            ...
            $this.find('#vertical_t_line_forward').addClass('forward-clicked');
            ...
            $this.find('#vertical_t_line_forward').removeClass('forward-clicked');
        ...
        searchBarToggle: function () {
            ...
            $this.find('.vertical_search_bar_holder').slideToggle(200);
        ...
        createElements: function () {
            ...
            if (data.options.search_bar_position == 0) {
                html = '\n' +
                    ...
                    '    <div class="vertical_timeline_line" style="text-align: left; position:relative; margin-left:auto; margin-right:auto;">\n' +
                    '	 </div>\n';
                $this.prepend(html);
            }
            else {
            ...
            var timelineWidth = $this.find('.vertical_timeline_line').width(),
                nodes = new Array(),
            ...
            $items.each(function (index) {
                ...
                if (data.options.my_is_years) {
                    ...
                    if (myYearsCount <= data.options.my_years_view) {
                        ...
                        // Store node element
                        nodes[dataId] = '<a href="#' + dataId + '" class="vertical_t_line_node' + isActive + '" style="left: ' + leftPos + '%; position:absolute; text-align:center;">' + nName;

                        if (typeof dataDesc != 'undefined') nodes[dataId] += '<span class="vertical_t_node_desc ' + (dataDesc ? '' : 'vertical_t_node_desc_empty') + '" style="white-space:nowrap; position:absolute; z-index: 1;" ><span>' + dataDesc + '</span></span>';
            ...
            html = '\n' +
                '		<div id="vertical_t_line_backward" style="position: absolute; display:none;" data-clicked="false"></div><div id="vertical_t_line_left" style="position: absolute;"></div><div id="vertical_t_line_right" style="position: absolute;"></div><div id="vertical_t_line_forward" style="position: absolute; display:none;" data-clicked="false"></div><div id="vertical_search_timeline_bar_icon" style="position: absolute; display:none;"></div>\n' +
                '		<div class="vertical_t_line_holder" style="position:relative; overflow: hidden; width:100%;">\n' +
                '			<div class="vertical_t_line_wrapper" style="white-space:nowrap;">\n';
                ...
                if (data.options.my_is_years) {
                    ...
                    if (myYearsCount <= data.options.my_years_view) {
                        ...
                        if (!firstMonth) {
                            html +=
                                '					<div class="vertical_t_line_m right" style="position:absolute; top:0;">\n' +
                                '						<h4 class="vertical_t_line_month_year" style="position:abolute; width:100% top:0; text-align:center;"></h4>\n' +
                                '					</div>\n' +
                                '					<div style="clear:both"></div>\n' +
                                '				</div>';
                            cnt++;
            ...
            $this.find('.vertical_timeline_line:first').html(html);
            $this.find('.vertical_t_line_node').each(function () {
                var $thisNode = $(this);
                $(this).find('span').hide();
                $(this).hover(function () {
                    ...
                    $(".my_vertical_timeline_hover_12_123").finish();
                    var $this = $(this).parents('.vertical_timeline');
                    var settings = $this.data('my_settings');
                    var my_transitions = settings.my_transitions;
                    $this.VerticalTimeline('my_debug', 'Hover', {s: settings, trans: my_transitions});
                    var off = $(this).offset();
                    var html1 = $(this).find('.vertical_t_node_desc').html();
                    var my_settings = $this.data('my_settings');
                    var my_transitions = my_settings.my_transitions;
                    var my_pfx = my_settings.my_pfx;
                    var html;//='<span class="vertical_t_node_desc" style="top:0px;opacity:1;">'+html1+"</span>";
                    if (my_transitions) {
                        html = '<span class="vertical_t_node_desc" style="' + my_pfx + '-transform:top 200ms,opacity 500ms">' + html1 + "</span>";
                    } else {
                        html = '<span class="vertical_t_node_desc" style="top:0px;opacity:1;">' + html1 + "</span>";
                    }
                    var id = $this.attr('id');
                    $(".my_vertical_timeline_hover_12_123").attr('id', id);
                    $(".my_vertical_timeline_hover_12_123").html(html);
                    $(".my_vertical_timeline_hover_12_123").find('span').show();
                    $(".my_vertical_timeline_hover_12_123").find('.vertical_t_node_desc').css({opacity: 1, top: '0px'});
                    var w = $(".my_vertical_timeline_hover_12_123").width();
                    ...
                    $(".my_vertical_timeline_hover_12_123").finish();
                    $(".my_vertical_timeline_hover_12_123").animate({opacity: 0}, 500, function () {
                ...
                if ($(this).hasClass('active')) {
                    data.lineMargin = -parseInt($(this).parent().parent('.vertical_t_line_view').attr('data-id'), 10) * 100;
                    if (data.options.rtl) {
                        $this.find('.vertical_t_line_wrapper').css('margin-right', data.lineMargin + '%');
                    }
                    else $this.find('.vertical_t_line_wrapper').css('margin-left', data.lineMargin + '%');
                }
                // Bind goTo function to click event
                $(this).click(function (e) {
                    e.preventDefault();
                    $this.find('.vertical_t_line_node').removeClass('active');
            ...
            $this.find('#vertical_t_line_left').click(function () {
                $this.VerticalTimeline('lineLeft');
            });

            $this.find('#vertical_t_line_right').click(function () {
                $this.VerticalTimeline('lineRight');
            });

            $this.find('#vertical_t_line_forward').click(function () {
                $this.VerticalTimeline('lineForward');
            });

            $this.find('#vertical_search_timeline_bar_icon').click(function () {
                $this.VerticalTimeline('searchBarToggle');
            });
    ...
    $.fn.VerticalTimeline = function (method) {
        ...
        if (t_methods[method]) {
            ...
            $.error('Method ' + method + ' does not exist on jQuery.Verticaltimeline');
        }
