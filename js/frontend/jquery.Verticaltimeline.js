	...
	var t_methods = {
       ...
       // return;
			...
			//	var $this = this,
				...
				$this.find('.vertical_vertical_timeline_items_holder').css({overflow:'hidden',height: total+'px', marginLeft : 'auto', marginRight : 'auto'});
			...
			my_500px_window_function=function(){
				...
				if(containerWidth<=my_trigger_width){
					...
					if(containerWidth<itemOpenWidth){
						...
						//$this.find(".item_open a.vertical_con_borderImage").width(containerWidth);
						//$this.find(".item_open_cwrapper").width(containerWidth);
						
					}else {
						$this.find(".item_open_cwrapper").width(itemWidth);
						$this.find(".item_open a.vertical_con_borderImage").css('left','');
						//$this.find(".item_open a.vertical_con_borderImage").width(itemOpenWidth);
            ...
            if(settings.search_bar_position == 0) {
     		...
     		//$this.find('.vertical_vertical_timeline_items_holder').css({width: my_w_12+'px', marginLeft : 'auto', marginRight : 'auto'});
     	...
     	//	if(my_w_12<600){
				...
				//my_scale_1=parseFloat($this.find(".vertical_vertical_timeline_items_wrapper").css(my_prop));
				/*
				if(my_w_item_12>my_w_12){
					...
					if(my_transitions){
						...
						//$this.find(".vertical_timeline_items").css(my_prop,'scale('+my_scale+')');
						//$this.find(".my_vertical_vertical_timeline_items_wrapper").css(my_prop,'scale('+my_scale+')');
						$this.find(".vertical_vertical_timeline_items_wrapper").width(my_w_item_12);
						$this.find(".vertical_vertical_timeline_items_wrapper").css(my_prop,'scale('+my_scale+')');
						$this.find(".vertical_vertical_timeline_items_holder").width(my_w_item_12);
						var my_left_12_123=(my_w_item_12*(1-my_scale))/2;
						$this.find(".vertical_vertical_timeline_items_wrapper").css('margin-left','-'+my_left_12_123+'px');
						...
						//$this.find(".vertical_vertical_timeline_items_holder").css(my_prop,'scale('+my_scale+')');
					...
					$this.find(".vertical_vertical_timeline_items_wrapper").css('width','');
					$this.find(".vertical_vertical_timeline_items_wrapper").css(my_prop,'');
					$this.find(".vertical_vertical_timeline_items_holder").css('width','');
				//	var my_left_12_123=(my_w_item_12*(1-my_scale))/2;
					$this.find(".vertical_vertical_timeline_items_wrapper").css('margin-left','');
	...
	//		}
			...
			*/
			...
			if(my_debug_12&&window.console){
				...
				$this.find(".vertical_timeline_items").animate({'margin-top':m_l,'queue':'my_left_12'},350,function(){
					var data = $("#vtl"+settings.my_id).data('vrt_timeline');
			...
			$(window).resize(function() {
				...
				if(my_w_12<500){
	     		...
	     		//my_w_12-=40;
				//$this.find('.vertical_vertical_timeline_items_holder').css({width: my_w_12+'px'});
				/*
				 * end changes
				 */
		 	...
		 	/*$('.vertical_timeline_items .my_open_dialog').on('mousedown',function(e){
		 		e.preventDefault();
				e.stopPropagation();
		 	});
			...
			if(my_diff<60&&my_diff>0){	
				...
				/*var my_w_1=my_w-40;
				var my_style=$this.find(".vertical_t_line_holder").attr('style');
				if(window.console){
				...
				$this.find(".vertical_t_line_holder").attr('style',my_style);
				//$this.find(".vertical_timeline_line").css('width',my_w_1+'px !important')
				*/
			}else {
			...
			if(my_curr>0){
				...
				//	if(my_count==my_start_item){
					...
					/*if(ci12==0){
						...
						var my_left_off_1=$this.find(".vertical_vertical_timeline_items_holder").offset().left;
...
'		</div>\n';
			...
			$this.find('.vertical_t_line_node').each(function(){
				...
				$(this).hover(function(){
					...
					//$(".my_vertical_timeline_hover_12_123").find(".vertical_t_node_desc").animate({top:0},300);
					/*
					if(settings.is_mobile==0){
					var my_data_id_12=$(this).parents(".vertical_t_line_view").data('id');
					var $my_i=$this.find(".vertical_t_line_view");
					...
					$this.find(".vertical_t_line_holder").css('overflow','');
					/**
					 * end changes
					 *
					...
					/*if(settings.is_mobile==0){
					$this.find(".vertical_t_line_holder").css('overflow','hidden');
					var my_data_id_12=$(this).parents(".vertical_t_line_view").data('id');
			...
			$this.find('.vertical_t_line_node').each(function(){
				...
				$(this).hover(function(){
					...
					/*var c=$this.find(".vertical_t_line_view").length-1;
				...
				*
				...
				if($(this).hasClass('active')) {
					data.lineMargin = -parseInt($(this).parent().parent('.vertical_t_line_view').attr('data-id'),10)*100;
					$this.find('.vertical_t_line_wrapper').css('margin-left', data.lineMargin+'%');
				}
				// Bind goTo function to click event
				$(this).click(function(e){
					e.preventDefault();
