<div class="wrap">
    <h2>Timelines
        ...
        if (empty($wp_v_my_timeline_has_wmpl)) {
            ?>
            <a href="<?php echo admin_url("admin.php?page=verticalcontenttimeline_edit"); ?>" class="add-new-h2">Add
                New</a>
            <?php
        } else {
            ...
            foreach ($wp_my_timeline_wpml_languages as $k123 => $v123) {
                ...
                <a class="add-new-h2"
                   href="<?php echo admin_url("admin.php?page=verticalcontenttimeline_edit&lang=" . $v123['code']); ?>"><?php echo __("Add new in", 'my_vertical_content_timeline') . ' - ';
                    echo $v123['display_name']; ?></a>
                <?php
            }
        }
        ?>
    ...
    <div style="margin-top:20px;">
        ...
        <ul>
            ...
            <li><h3>3. Copy "shortcode" from table and use it in your post or page. (for adding timeline into .php parts
                    of template use it like this "&lt;?php do_shortcode('[vertical_content_timeline id="X"]') ?&gt;"
                    where X is id of your timeline)</h3></li>
