...
class vusquare_functions
{
    ...
    static public function get_root_of_uploads_dir($with_slash = 0)
    {    // return full filepath without / on end
    ...
    static public function get_current_upload_dir($with_slash = 0)
    {    // return full filepath without / on end
    ...
    static public function get_relative_urlpath_for_wordpress_folder()
    {    // return relative to webroot URL
        $wp_url = get_site_url() . "/";
    ...
    static public function get_full_urlpath_for_wordpress_folder()
    {    // return relative URL
        return get_site_url() . "/";
    }

    static public function get_full_urlpath_of_domain($with_slash = 1)
    {    // return full URL with /
        $wp_url = get_site_url() . "/";
        $pos = strpos($wp_url, "/", 8);
        return substr($wp_url, 0, $pos + $with_slash);
    }

    static public function get_webroot_filepath()
    {    // return full folderpath, ended with /
        $wp_path = ABSPATH;
    ...
    static public function get_relative_to_wordpress_urlpath_from_full_urlpath($url)
    {    // return relative URL without /
    ...
    static public function get_relative_to_webroot_urlpath_from_full_urlpath($url)
    {    // return relative URL with /
        $pos = strpos($url, '/', 8);
        return substr($url, $pos);
    }

    static public function get_full_urlpath_from_relative_urlpath($url)
    {    // return full URL
    ...
    static public function get_relative_to_wordpress_urlpath_from_full_filepath($file)
    {    // return relative URL without /
        $wp_path = ABSPATH;
        if (strtoupper(substr(PHP_OS, 0, 3)) === 'WIN') $wp_path = str_replace("/", "\\", $wp_path);
        $wp_path_length = strlen($wp_path);
    ...
    static public function get_relative_to_webroot_urlpath_from_full_filepath($file)
    {    // return relative URL with	/
    ...
    static public function get_full_urlpath_from_full_filepath($file)
    {    // return full URL
        $wp_path = ABSPATH;
        $wp_url = get_site_url() . "/";
        if (strtoupper(substr(PHP_OS, 0, 3)) === 'WIN') $wp_path = str_replace("/", "\\", $wp_path);
    ...
    static public function get_full_urlpath_from_relative_to_wordpress_filepath($file)
    {    // return full URL
        $wp_url = get_site_url();
    ...
    static public function get_full_urlpath_from_relative_to_webroot_filepath($file)
    {    // return full URL
        $wp_url = get_site_url() . "/";
    ...
    static public function get_full_filepath_from_relative_filepath($file)
    ...
    static public function get_relative_filepath_from_full_filepath($file)
    ...
    static public function get_full_filepath_from_full_urlpath($url)
    {    // return full filepath
        $slash = "/";
        if (strtoupper(substr(PHP_OS, 0, 3)) === 'WIN') $slash = "\\";
        $wp_path = ABSPATH;
    ...
    static public function get_full_filepath_from_relative_to_wordpres_urlpath($url)
    {    // return full filepath
        $slash = "/";
        if (strtoupper(substr(PHP_OS, 0, 3)) === 'WIN') $slash = "\\";
        $wp_path = ABSPATH;
    ...
    static public function get_full_filepath_from_relative_to_webroot_urlpath($url)
    {// return full filepath
        if (substr($url, 0, 1) == '/') $url = substr($url, 1);
    ...
    static public function get_filepath_from_url_smart($url)
    {    // MAIN FUNCTION FOR GETTING FILEPATH FROM URL
    ...
    static public function get_filepath_from_url($url)
    {    // shortcut for getting filepath from database via guid
