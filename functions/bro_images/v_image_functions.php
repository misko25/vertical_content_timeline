...
abstract class vall_around_image_class
{
    ...
    function pre_save()
    {    // get: $this->orig_file, $this->dest_suffix (optional), $this->dest_path (optional), $this->dest_w (optional), $this->dest_h (optional)
    ...
    function post_save($dest_file)
    {    // chmod for saved file
    ...
    function pre_load(&$orig_file)
    {    // check if file exists, define $this->orig_file
        if (isset($GLOBALS['wp'])) {
    ...
    function post_load($orig_w, $orig_h, $orig_type)
    {    // define $this->orig_w, $this->orig_h, $this->orig_type, $this->dest_w, $this->dest_h
        $this->orig_w = $orig_w;
        $this->orig_h = $orig_h;
...
class fol_gd extends vall_around_image_class
{
    function __destruct()
    {
...
class fol_imagick extends vall_around_image_class
{
    function __destruct()
    {
