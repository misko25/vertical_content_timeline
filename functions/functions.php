...
function wp_v_my_timeline_render_element($name,$element){
	...
	switch($type){
		...
		case 'text':
			?>
		<input type="text" value="<?php if(isset($value))echo esc_attr($value);?>" name="<?php echo esc_attr($name);?>" id="<?php echo esc_attr($name)?>" size="<?php /* if(isset($element['size']))echo esc_attr($element['size']);*/?>3"/>
